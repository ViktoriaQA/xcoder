  ...
  const sections: ContractSection[] = [
    {
      ...
      content: [
        t('contract.section_1_1', `Даний Договір пубічної оферти (далі – "Договір") є офіційною пропозицією ${platformLink} (далі – "Компанія") укласти договір про надання послуг платформи ${platformLink} (далі – "Послуги") на умовах, викладених нижче.`),
        t('contract.section_1_2', 'Згідно зі статтею 641 Цивільного кодексу України, у разі прийняття умов цього Договору шляхом реєстрації на платформі OlimpX, фізична чи юридична особа, яка приймає цю пропозицію, стає Замовником.'),
        t('contract.section_1_3', `Договір набирає чинності з моменту реєстрації Замовника на платформі ${platformLink} та діє до моменту виконання сторонами своїх зобов'язань.`),
        t('contract.section_1_4', `Компанія залишає за собою право вносити зміни до умов цього Договору, повідомляючи Замовника шляхом розміщення нової редакції на платформі ${platformLink} .`)
      ]
    },
    {
      id: '2',
      ...
      content: [
        t('contract.section_2_1', `Компанія зобов'язується надавати Замовнику доступ до платформи ${platformLink} для організації та участі в освітніх змаганнях з програмування.`),
    ...
    },
    {
      ...
      content: [
        t('contract.section_5_1', `Вартість Послуг визначається відповідно до тарифних планів, розміщених на платформі ${platformLink}.`),
    ...
    },
    {
      ...
      content: [
        t('contract.section_8_1', `Даний Договір діє протягом усього періоду використання Замовником послуг платформи ${platformLink} .`),
        ...
        t('contract.section_8_4', `Зміни до Договору набирають чинності з моменту їх розміщення на платформі ${platformLink} .`)
      ]
    },
    {
      id: '9',
    ...
    },
    {
      ...
      content: [
        ...
        t('contract.section_10_3', `Всі повідомлення та повідомлення між сторонами надсилаються електронною поштою або через платформу ${platformLink} .`),
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <div className="text-center text-gray-600 text-sm">
              <p dangerouslySetInnerHTML={{ 
                  __html: t('contract.contract_footer_note', `Реєструючись на платформі ${platformLink}, ви підтверджуєте, що ознайомилися з умовами цього Договору та повністю погоджуєтеся з ними.`)
                }}></p>
              {/* <p>
