 ...
 const CompanyLink = () => (
  ...
  const sections: ContractSection[] = [
    ...
    },
    {
      ...
      content: [
        t('contract.section_3_1', 'Оплата послуг здійснюється в українських гривнях у безготівковому порядку за допомогою: сервісу Online платежу MonoPay (https://www.monobank.ua) або платежу на розрахунковий рахунок.'),
        t('contract.section_3_2', 'У випадку оплати за допомогою сервісу Online платежу MonoPay Замовник перенаправляється на платіжний сервіс MonoPay, де Замовник має змогу сплатити за допомогою карток платіжних систем Visa та Mastercard. В цьому випадку оплата додатково регулюється правилами платіжного сервісу, банку (в тому числі банку емітента картки Замовника) та інших учасників платежів. Виконавець не здійснює обробку операцій по банківським карткам. У разі виникнення помилок або відмов в оплаті Замовник має звернутися до банку емітенту картки або до представника платіжної системи, через яку здійснювалась оплата.'),
        t('contract.section_3_2_1', 'Компанія не зберігає дані банківських карток Замовника. Усі платежі проходять через захищений платіжний шлюз MonoPay, який відповідає стандартам безпеки PCI DSS. Дані карток передаються безпосередньо до платіжної системи через зашифроване з\'єднання.'),
    ...
    },
    {
      ...
      content: [
        ...
        t('contract.section_11_5', 'При поверненні коштів сума комісії платіжних систем (включно з комісією MonoPay) не компенсується та утримується з суми повернення.'),
        t('contract.section_11_6', 'У випадку оплати через платіжну систему MonoPay, повернення коштів можливо лише через цю ж платіжну систему згідно з її правилами та термінами.'),
