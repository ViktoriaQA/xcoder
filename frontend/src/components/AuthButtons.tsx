...
<>
      <div className="flex gap-3">
        <Button
          ...
          disabled={isLoading}
        >
          <svg className="w-4 h-4 mr-2 transition-transform group-hover:scale-110" viewBox="0 0 24 24">
        ...
        <Button
          ...
          disabled={isLoading}
        >
          <svg className="w-4 h-4 mr-2 transition-transform group-hover:scale-110 group-hover:rotate-12" viewBox="0 0 24 24" fill="currentColor">
