...
export function Loading({ fullScreen = true }: LoadingProps) {
  return (
    <div className={`${fullScreen ? 'fixed inset-0' : 'flex items-center justify-center min-h-screen'} flex items-center justify-center bg-background matrix-bg z-50`} data-testid="loading">
